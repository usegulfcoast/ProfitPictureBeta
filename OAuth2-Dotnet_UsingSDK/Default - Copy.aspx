...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <form id="form1" runat="server">
            ...
            <!-- Sign In With Intuit Button -->
             ...
             <div id="connected" runat="server" visible ="false">
                ...
                <asp:TextBox ID="txtrpt" runat="server">GeneralLedger</asp:TextBox>
                <asp:Button id="btnQBOAPICall" runat="server" Text="Call QBO API" OnClick="btnQBOAPICall_Click"/>
                 <br />

                  
                <asp:Button id="btninsertstmt" runat="server" Text="Generate Insert Stmts" OnClick="btninsertstmt_Click"/>
 ...
 <asp:TextBox TextMode="MultiLine" Rows="40" Columns="250" runat="server" ID="txtlog"></asp:TextBox>
